...
// Configuare https
//const httpsOption = {
//    key : fs.readFileSync("./root/rtc/server/2_p1nk64.top.key"),
//    cert: fs.readFileSync("./root/rtc/server/1_p1nk64.top_bundle.crt")
//}
// Create service
//let app = express();
...
var options = {
  key: fs.readFileSync('./2_p1nk64.top.key'),
  cert: fs.readFileSync('./1_p1nk64.top_bundle.crt')
}
var serverPort = 9000;
